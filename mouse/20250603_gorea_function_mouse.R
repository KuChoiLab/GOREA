# ------------------------------------------------------------------
# Script Name: 20250603_gorea_function_mouse.R
# Author: Hojin Lee
# Date: 2025-06-03
# ------------------------------------------------------------------
...
gorea_enviromnet <- function(directory = NULL) {
  ...
  GOID_TERM <- read.table(paste0(directory, "/GeneOntology/v2024.1.Mm/GOBP/20250124_m5.go.bp.v2024.1.Mm.term.id_mapping.txt"),
                          header = T,
                          sep = "\t") # this file is made from json file
  GO.ANCESTOR <<- readRDS(paste0(directory, "/GeneOntology/v2024.1.Mm/GOBP/20250124_m5.go.bp.v2024.1.Mm_ANCESTOR_df.rds"))
  GO.LEVEL <<- readRDS(paste0(directory, "/GeneOntology/v2024.1.Mm/GOBP/20250124_m5.go.bp.v2024.1.Mm_LEVEL_df.rds"))
  ...
  GO.LARGE <<- readRDS(paste0(directory, "/GeneOntology/v2024.1.Mm/GOBP/20250206_msigDB_GO_ancestor_large.rds"))
